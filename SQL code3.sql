...
select first_name,salary from emp order by salary desc limit 1 offset 2 ;

#question 6

select emp_no,first_name as full_name,salary,rank() over(order by salary desc) as salary_rank
from emp ;
select*from emp